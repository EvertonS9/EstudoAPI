...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	private static final String MSG_ERROR_GENERIC_FINAL_USER = "Ocorreu um erro interno inesperado no sistema."
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s',"
				+ "que é de um tipo inválido. Corrija informe um valor compatível com o tipo"
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String detail = "O corpo da requisição está inválido. Verfique erro de sintaxe";
	...
	private ResponseEntity<Object> handlePropertyBindingException(PropertyBindingException ex,
		...
		ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
		String detail = String.format("A propriedade '%s' não exite."
	...
	public ResponseEntity<?> handleNegocioException(
		...
		ProblemType problemType = ProblemType.RESQUEST_ERROR;
		String detail = ex.getMessage();
